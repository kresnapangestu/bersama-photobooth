export default function PrivacyTemplate() {
  return (
    <div className="p-6 flex flex-col items-center gap-6 font-medium justify-center h-fit">
      <span className="text-[50px] mt-20 font-semibold">Privacy Policy</span>
      <div className="w-[50vw] text-[20px] text-justify pb-32">
        ...
        <br /> When you visit our site or interact with our services, we might
        ask for:
        <ul className="list-disc pl-6">
          ...
          <li>
            Support Info: Any details you share with us when you reach out for
            help or to make your experience better.
          </li>
        </ul>
        <br />
        <span className="text-[40px]">
        ...
        browsing experience and help us learn how you interact with our
        services. These cookies might gather your IP address, browser details,
        and how you use our site. You can control cookie settings via your
        browser if you wish!
        <br />
        <br />
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            partners, who help fulfill your order and ensure your photoshoot
            memories reach you safely.
          </li>
          <li>
            Marketing Partners: To bring the magic to the right people through
            ads or promotions—always with a sprinkle of fun!
          </li>
          <li>
            Business Transactions: In the event of a merger or acquisition, your
            data might be transferred to ensure you continue to receive our
            services.
          </li>
        </ul>
        <br />
        <span className="text-[40px]">User-Generated Content</span> <br />
        <br /> If you choose to share your photos or feedback with us, please
        remember that these will be public for others to see. Always share what
        makes you happiest!
        <br />
        <br />
        ...
        <br /> While we take the utmost care to protect your personal
        information, remember that no system is completely foolproof. We
        recommend you use secure channels when sharing sensitive info with us.
        <br />
        <br />
        <span className="text-[40px]">Contact Us</span> <br />
        <br />
        Got questions or want to chat about your privacy with us? Feel free to
        reach out! You can contact us via email at contact@bersama.com.
      </div>
    </div>
  );
}
